...
while($row = mysqli_fetch_array($covid)){
	...
	$jumlah_kasus[] = $row['new death'];
}
?>
<!DOCTYPE html>
<html>
<head>
	<title>Grafik Perbandingan Kematian Baru Covid 10 Negara</title>
	<script type="text/javascript" src="Chart.js"></script>
</head>
<body>
	<h2><center>GRAFIK PERBANDINGAN KEMATIAN BARU COVID 10 NEGARA</center></h2><br>
	<b>GRAFIK BAR</b>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: 'Grafik Kematian Baru Covid di setiap Negara',
