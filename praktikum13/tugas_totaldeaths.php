...
while($row = mysqli_fetch_array($covid)){
	...
	$jumlah_kasus[] = $row['total death'];
}
?>
<!DOCTYPE html>
<html>
<head>
	<title>Grafik Perbandingan Jumlah Kematian Covid 10 Negara</title>
	<script type="text/javascript" src="Chart.js"></script>
</head>
<body>
	<h2><center>GRAFIK PERBANDINGAN JUMLAH KEMATIAN COVID 10 NEGARA</center></h2><br>
	<b>GRAFIK BAR</b>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: 'Grafik Jumlah Kematian Covid di setiap Negara',
