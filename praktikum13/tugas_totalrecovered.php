...
while($row = mysqli_fetch_array($covid)){
	...
	$jumlah_kasus[] = $row['total recovered'];
}
?>
<!DOCTYPE html>
<html>
<head>
	<title>Grafik Perbandingan Total Kesembuhan Covid 10 Negara</title>
	<script type="text/javascript" src="Chart.js"></script>
</head>
<body>
	<h2><center>GRAFIK PERBANDINGAN TOTAL KESEMBUHAN COVID 10 NEGARA</center></h2><br>
	<b>GRAFIK BAR</b>
	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					label: 'Grafik Total Kesembuhan Covid di setiap Negara',
